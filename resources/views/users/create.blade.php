            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold">Criar Novo Usuário</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('users.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                <label for="senha" class="form-label fw-medium">Senha <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label for="senha_confirmation" class="form-label fw-medium">Confirmar Senha <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('papel') is-invalid @enderror" id="papel" name="papel" required>
                                    <option value="usuario" {{ old('papel') == 'usuario' ? 'selected' : '' }}>Usuário</option>
                                    <option value="admin" {{ old('papel') == 'admin' ? 'selected' : '' }}>Admin</option>
                                </select>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-4">
                                <label for="cep" class="form-label fw-medium d-flex align-items-center">
                                    CEP
                                    <span id="cep-loading" class="spinner-border spinner-border-sm text-primary ms-2 d-none" role="status"></span>
                                </label>
                                <input type="text" class="form-control @error('cep') is-invalid @enderror" id="cep" name="cep" value="{{ old('cep') }}" maxlength="9">
                            </div>
                            <div class="col-md-8">
