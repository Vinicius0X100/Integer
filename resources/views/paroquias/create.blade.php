...
@section('page-title', 'Nova Paróquia - SisMatriz')
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-white border-bottom p-4">
                    <h5 class="mb-0 fw-bold">Cadastrar Nova Paróquia</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('paroquias.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <div class="position-relative">
                                    <div class="drop-zone p-5 rounded-4 text-center position-relative transition-all" id="dropZone" style="border: 2px dashed var(--apple-border); background-color: rgba(0,0,0,0.02); transition: all 0.3s ease;">
                                        ...
                                        <div class="d-flex flex-column align-items-center justify-content-center" id="dropZoneContent">
                                        ...
                                        <div id="imagePreviewContainer" class="d-none position-absolute top-0 start-0 w-100 h-100 bg-white rounded-4 d-flex align-items-center justify-content-center z-1 overflow-hidden" style="background-color: var(--apple-card-bg) !important;">
                                            <img src="" alt="Preview" id="imagePreview" class="h-100 w-100" style="object-fit: contain;">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('paroco') is-invalid @enderror" id="paroco" name="paroco" value="{{ old('paroco') }}">
                                @error('paroco')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('diocese') is-invalid @enderror" id="diocese" name="diocese" value="{{ old('diocese') }}">
                                @error('diocese')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" inputmode="numeric" class="form-control @error('region') is-invalid @enderror" id="region" name="region" value="{{ old('region') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                                @error('region')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    <option value="0" {{ old('status') == '0' ? 'selected' : '' }}>Ativa</option>
                                    <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>Inativa</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
