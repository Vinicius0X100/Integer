...
@section('page-title', 'Novo Usuário - SisMatriz Principal')
            ...
            <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                <div class="card-header bg-white border-bottom p-4">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0 fw-bold">Criar Novo Usuário SisMatriz Principal</h5>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('sismatriz-main.store') }}" method="POST" id="createSisMatrizMainUserForm">
                        @csrf
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control @error('user') is-invalid @enderror" id="user" name="user" value="{{ old('user') }}" required>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    <option value="0" {{ old('status', '0') == '0' ? 'selected' : '' }}>Ativo</option>
                                    <option value="1" {{ old('status') == '1' ? 'selected' : '' }}>Inativo</option>
                                </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('createSisMatrizMainUserForm');
